  ...
  return (
    <DashboardLayout dashboardType="utility">
      <div className="space-y-8">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold mb-2 dark:text-gray-100">Utility Dashboard</h1>
          <p className="text-gray-600 dark:text-gray-300">Monitor and optimize your energy distribution network</p>
        </div>
